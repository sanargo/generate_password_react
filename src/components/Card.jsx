function Card({ onClick, passwordOne, passwordTwo, darkMode }) {
  return (
    <main className={darkMode ? "dark" : " "}>
      <div className="bg-green-50 w-80 md:w-96 p-5 mx-auto dark:bg-gray-900">
        ...
        <div className="border-t border-gray-800 mt-8 py-8 flex gap-3 text-emerald-400 text-center text-xs md:text-sm">
          <div className="w-3/6 bg-slate-800 rounded-md p-1 h-8 flex items-center justify-center cursor-pointer">
            {passwordOne}
          </div>
          <div className="w-3/6 bg-slate-800 rounded-md p-1 h-8 flex items-center justify-center cursor-pointer">
            {passwordTwo}
